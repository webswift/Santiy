...
<section>
	<div class="leftpanel">
		<div class="logopanel"><img src="{{ URL::asset("assets/images/logo.png") }}" style="height: 30px;"/></div><!-- logopanel -->

		<div class="leftpanelinner"></div><!-- leftpanelinner -->
	</div><!-- leftpanel -->
	...
	<div class="mainpanel">
		...
		<div class="pageheader">
			<h2><i class="glyphicon glyphicon-edit"></i> Lead Form Preview</h2>
		</div>
						...
						<div class="form-group">
							...
							@elseif($leadFormDatas1[$i]['type'] == 'date')
								<div class="col-sm-6">
									...
									<div class="input-group">
										...
										<input type="text" class="form-control preDefineformfields customDateField">
									</div>
									</div>
								</div>
							@elseif($leadFormDatas1[$i]['type'] == 'dropdown')
								<div class="col-sm-6">
									<label class="col-sm-3 control-label">{{ $leadFormDatas1[$i]['fieldName'] }}</label>
									<div class="col-sm-9">
										<select class="form-control preDefineformfields">
										<option value="">Select</option>
										@foreach($leadFormDatas1[$i]['values'] as $data)
								...
								@elseif($leadFormDatas1[$i+1]['type'] == 'dropdown')
									<div class="col-sm-6">
										...
										<div class="col-sm-9">
											<select class="form-control preDefineformfields">
											<option value="">Select</option>
											@foreach($leadFormDatas1[$i+1]['values'] as $data)
											<option value="{{$data}}">{{$data}}</option>
											@endforeach
											</select>
										</div>
