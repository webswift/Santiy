...
<div class="contentpanel">
    <div class="panel panel-default">
        <div class="panel-heading">
            ...
            <p>Edit your mass mail message here</p>
        </div>

        <form class="form-horizontal form-bordered" action="{{ URL::route('user.email.mass.update', ['id' => $template->id]) }}" id="templateCreateForm">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <select name="datasetType" id="datasetType" class="form-control">
                            ...
                            <option value="campaign" @if($template->type == 'campaign') selected @endif>Campaign</option>
                            <option value="custom" @if($template->type == 'custom') selected @endif>Import mailing list</option>
                        </select>
                        <span class="help-block"></span>
                    </div>
                </div>
...
<script type="text/javascript">
    $(function() {
        ...
        MassEmail.setTemplateType('edit');
        ...
        @if($template->type == 'campaign')
            $('#campaign').val({{ $template->campaign_id }});
            $('#campaign').trigger('change');
        @else
            $('#leadEmailCountDiv').removeClass('hidden').html('{{ $emailCount }}');
        @endif
    });
</script>
@stop
