        ...
        <form class="form-horizontal form-bordered" action="{{ URL::route('user.email.mass.store') }}" id="templateCreateForm">
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" placeholder="From Name" id="from_name" name="from_name" class="form-control">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
						<input type="email" placeholder="Send From Address" id="from_email" name="from_email" 
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="email" placeholder="Reply To" id="reply_to" name="reply_to" class="form-control">
                        <span class="help-block"></span>
                    </div>
                </div>
                ...
                <div class="form-group campaignDiv hidden">
                    ...
                    <div class="col-md-2 hidden" id="advanceButton">
                        <button type="button" id="adButton" class="btn btn-default" title="Targeting Options">Targeting Options</button>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" placeholder="Template Name" id="name" name="name" class="form-control">
                        <span class="help-block"></span>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <div class="form-group" id="fileDetails"></div>
                    </div>
                </div>
